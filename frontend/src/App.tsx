      ...
      <div className="absolute z-10 flex flex-col w-full h-full justify-between pointer-events-none">
        <div className="flex justify-between">
          <a href="#" className="pointer-events-auto">
            <img src="/pyGold.svg" className="h-16 px-4 py-2 m-4 bg-gray-100 rounded-2xl" alt="pyGold Logo" />
          </a>
          <div className="flex items-center">
            <input type="text" className="bg-gray-100 text-gray-700 tracking-widest font-mono rounded-2xl w-80 h-16 m-4 px-8 pointer-events-auto" placeholder="Enter input..." />
